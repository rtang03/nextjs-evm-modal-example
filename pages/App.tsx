...
// my second project
const clientId = "BKX5drrvBJDRJy6icyILmxXKCq0jIKNk7MZtA-TNHaSIeNtXsgML7_eUJVsUcDlgjxGO7ZTQE9Ilod05jpWg0KU"; // get from https://dashboard.web3auth.io
      ...
      try {
        ...
        const torusPlugin = new TorusWalletConnectorPlugin({
          ...
          walletInitOptions: {
            loginConfig: {
              google: {
                name: "Liviii", clientId: "207158575998-q5uibes2nc8m40mlj15pb3vj7rps42hg.apps.googleusercontent.com",
                typeOfLogin: "google",
                showOnMobile: true,
                showOnDesktop: true,
            ...
            initParams: {
                loginConfig: {
                    google: {
                        ...
                        clientId: "207158575998-q5uibes2nc8m40mlj15pb3vj7rps42hg.apps.googleusercontent.com",
                        typeOfLogin: "google",
                    }
                }
            }
